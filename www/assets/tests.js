...
define('ttexp/tests/routes/scenarios.jshint', ['exports'], function (exports) {
  ...
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(false, 'routes/scenarios.js should pass jshint.\nroutes/scenarios.js: line 72, col 11, \'pgFileSystemUtil\' is defined but never used.\nroutes/scenarios.js: line 213, col 28, \'FileTransfer\' is not defined.\n\n2 errors');
  });
});
...
define('ttexp/tests/services/file-system.jshint', ['exports'], function (exports) {
  ...
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(false, 'services/file-system.js should pass jshint.\nservices/file-system.js: line 90, col 39, \'reject\' is defined but never used.\nservices/file-system.js: line 26, col 34, \'LocalFileSystem\' is not defined.\n\n2 errors');
  });
});
