...
define('ttexp/tests/routes/scenarios.jshint', ['exports'], function (exports) {
  ...
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(false, 'routes/scenarios.js should pass jshint.\nroutes/scenarios.js: line 124, col 19, \'transition\' is defined but never used.\nroutes/scenarios.js: line 42, col 38, \'FileTransfer\' is not defined.\nroutes/scenarios.js: line 139, col 28, \'FileTransfer\' is not defined.\nroutes/scenarios.js: line 50, col 21, \'resolveLocalFileSystemURL\' is not defined.\nroutes/scenarios.js: line 75, col 38, \'LocalFileSystem\' is not defined.\nroutes/scenarios.js: line 88, col 19, \'$\' is not defined.\nroutes/scenarios.js: line 157, col 15, \'$\' is not defined.\nroutes/scenarios.js: line 184, col 13, \'displayImage\' is not defined.\nroutes/scenarios.js: line 191, col 8, \'onErrorReadFile\' is not defined.\nroutes/scenarios.js: line 208, col 8, \'onErrorReadFile\' is not defined.\nroutes/scenarios.js: line 194, col 10, \'readFile\' is defined but never used.\n\n11 errors');
  });
});
