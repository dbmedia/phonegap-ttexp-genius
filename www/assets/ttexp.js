...
define('ttexp/services/download-scenario', ['exports', 'ember'], function (exports, _ember) {
  ...
  exports['default'] = _ember['default'].Service.extend({
    ...
    fileSystem: _ember['default'].inject.service('file-system'),
    downloadSession: 0,
    retryLimit: 5, // Max download attempts for a single file, 0 = limitless
          ...
          _this.get('store').findRecord('manifesto', scenario.id, { reload: true }).then(function (manifesto) {
            ...
            if (mediaFileLength) {
              ...
              var downloadQueue = function downloadQueue() {
                ...
                if (mediaFile && downloadAttempts < 6) {
                  ...
                  confirmOrDownloadFile(fileRemotePath, fileLocalPath, function () {
                    ...
                    if (!retryLimit || downloadAttempts < retryLimit) {
                      // Retry
                      console.log("Retry downloading file: " + fileName);
                      downloadQueue();
                    } else {
                      // Error
                      mediaFileCounter++;
              ...
              scenario.get('isUpdated').then(function (isUpdated) {
                if (!isUpdated || forceDownload) {
                  self.download(scenario, onProgress, onStart, function () {
                    // Completed download of all scenario
                    currentScenarioIndex++;
                    downloadScenarioQueue(scenarios, currentScenarioIndex);
                  }).then(function () {
                    // Success downloading single file
                  }, function (reason) {
  ...
  exports["default"] = Ember.HTMLBars.template((function () {
    var child0 = (function () {
      ...
      return {
        ...
        statements: [["block", "link-to", ["scores", ["get", "model.scenario.playState.playthrough.id", ["loc", [null, [31, 52], [31, 91]]]]], [], 0, null, ["loc", [null, [31, 32], [31, 170]]]]],
        locals: [],
        templates: [child0]
      };
    })();
  ...
  exports["default"] = Ember.HTMLBars.template((function () {
    ...
    var child4 = (function () {
      var child0 = (function () {
        return {
          ...
          statements: [["element", "action", ["showModal", ["get", "score.variableName", ["loc", [null, [59, 58], [59, 76]]]], ["get", "score.variableDescription", ["loc", [null, [59, 77], [59, 102]]]]], [], ["loc", [null, [59, 37], [59, 104]]]], ["content", "score.variableName", ["loc", [null, [59, 105], [59, 127]]]]],
          locals: [],
          templates: []
        };
      })();
    ...
    var child6 = (function () {
      return {
        ...
        statements: [["content", "modalContent", ["loc", [null, [91, 1], [91, 17]]]]],
        locals: [],
        templates: []
      };
    })();
...
if (!runningTests) {
  require("ttexp/app")["default"].create({"serverApiUrl":"http://demo.ttexp.net/api","LOG_ACTIVE_GENERATION":false,"LOG_VIEW_LOOKUPS":false,"name":"ttexp","version":"1.1.0+a046da95"});
}
